 ...
 * per sensor kind the backend knows about. Non-finite (unreadable) values are
 * skipped, and a tick with an empty timestamp is sent without one. Returns the number of readings, or
