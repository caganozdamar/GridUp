...
| 8 | **Alarm dalgalanması (flapping) ve bildirim fırtınası** | Skor eşik civarında gidip gelir (gürültü ya da iki veri kaynağı) | Aynı pano için art arda alarm açılıp kapanır, **her yeni alarm yeni SMS/WhatsApp gönderir** | Gözlendi: aynı panoya iki kaynak yazarken (`demo:critical`'ın simülatörü ve büyük olasılıkla açık kalmış Wokwi; ikincisi süreç düzeyinde doğrulanamadı) alarm yaklaşık 2 sn arayla açılıp kapandı. Eşik histerezisi ve bildirim bekleme süresi (cooldown) **yok** | Çözülme için histerezis (N tick boyunca eşik altı), pano başına bildirim cooldown'u | **Eksik** |
